    ...
    def mis_instance_list(
        ...
        for instance in instances:
            ...
            if not instance.comparison_mode:
                instance_data["date_from"] = (
                    str(instance.date_from) if instance.date_from else None
                )
                instance_data["date_to"] = (
                    str(instance.date_to) if instance.date_to else None
                )
    ...
    def mis_instance_get(
        ...
        for period in instance.period_ids:
            ...
            period_data["date_from"] = (
                str(period.date_from) if period.date_from else None
            )
