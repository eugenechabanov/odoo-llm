    ...
    def mis_variance_analysis(
        ...
        return {
            ...
            "base_period": {
                ...
                "date_from": str(base_period.date_from)
                if base_period.date_from
                else None,
                "date_to": str(base_period.date_to) if base_period.date_to else None,
            },
            "compare_period": {
                "name": compare_period.name,
                "date_from": str(compare_period.date_from)
                if compare_period.date_from
                else None,
                "date_to": str(compare_period.date_to)
                if compare_period.date_to
                else None,
            },
