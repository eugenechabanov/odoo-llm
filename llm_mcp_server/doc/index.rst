...
Tools are auto-discovered from the ``llm.tool`` model. See `llm_tool module <https://github.com/apexive/odoo-llm/tree/16.0/llm_tool>`_ for creating custom tools.
