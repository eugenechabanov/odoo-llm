...
.. image:: ../static/description/screenshots/model_domain_for_automation.png
   :alt: Domain Filters Configuration
...
.. image:: ../static/description/screenshots/automation_triggers.png
...
.. list-table::
   ...
   * - ``automated_sync``
     ...
     - ``False``
   * - ``auto_process_resources``
     - Auto-run RAG pipeline for new resources
     - ``True``
   * - ``domain_ids``
     - List of domain filters
     - ``[]``
   * - ``automation_ids``
     - Generated automation rules (read-only)
     - ``[]``
