...
class AccountMove(models.Model):
    ...
    def action_process_with_llm(self):
        ...
        This button allows users to manually process an invoice that has an
        attachment. Useful for:
        ...
        Flow:
        1. Get attachment from invoice
        2. Extract data using account.invoice.import.ocr
        3. Update invoice fields and lines from extracted pivot data
        ...
        # which handles chatter messages, attachments, and warnings
